...
#
# Python script calling the XML-RPC errata.delete
...
def main(argv):
    ...
    client.errata.delete(*argv)

def usage():
    """
    Prints the usage information.
    """
    print("Python script calling the XML-RPC errata.delete")
    print("of Spacewalk frontend API.")
    print("")
    print("Usage:")
    print(" ./errata.delete.py session-key advisory-name")
    print("") 
